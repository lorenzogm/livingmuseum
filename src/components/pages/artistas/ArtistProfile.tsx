        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              {artist.quote && (
                <blockquote className="mb-8 p-6 border-l-4 border-white bg-gray-900 rounded-r-lg">
                  <Text
                    variant="heading"
                    color="light"
                    className="italic"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {artist.artworks.map((artwork) => (
              <div key={artwork.id} className="bg-gray-900 rounded-lg overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-1">
                    <Text variant="small" color="muted">{artwork.medium}</Text>
                    <Text variant="small" color="muted">{artwork.dimensions}</Text>
                    <Text variant="small" color="muted">{artwork.year}</Text>
                  </div>
                  {artwork.description && (
                    <Text
                      variant="small"
            ...
            <ul className="space-y-4">
              {artist.exhibitions.map((exhibition, index) => (
                <li key={index} className="flex items-start">
                  <span className="w-2 h-2 bg-white rounded-full mt-3 mr-4 flex-shrink-0" />
                  <Text
                    variant="body"
                    color="light"
                  >
