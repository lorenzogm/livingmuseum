...
import type { FamiliaContent } from '@/api/apiSdk';
                ...
                <div key={index} className="text-center space-y-4">
                  <div className="aspect-square bg-gray-100 rounded-full w-40 h-40 mx-auto overflow-hidden relative border border-gray-200">
                    <Image 
                      ...
                      fill
                      aspectRatio='1:1'
                      className={`object-cover ${{ center: 'object-center', bottom: 'object-bottom', top: 'object-top' }[member.imagePosition ?? 'top'] ?? 'object-top'}`}
